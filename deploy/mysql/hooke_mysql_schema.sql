-- Fresh-database bootstrap only. To upgrade a database from an earlier
-- experiment, run the hooke-migrate binary so guarded ALTER migrations execute.
SET NAMES utf8mb4;
SET time_zone = '+00:00';
...
INSERT IGNORE INTO schema_migrations(version) VALUES('000002_event_timing_quality');
INSERT IGNORE INTO schema_migrations(version) VALUES('000003_four_layer_timeline');
