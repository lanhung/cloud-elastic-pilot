...
| GOATScaler task-ID 归因 | G2 核心/无丢批均 5/5 完成；G3 1/5 通过，task-ID F1=1、时间窗口 F1=0.667，待剩余 G3 及 G1 | 是 | Pod annotation ↔ Node label；新增节点差集、唯一 Pod 与服务日志 Gate；与 K8s-only/时间窗口对照 |
