...
| GOATScaler task-ID 归因 | G2 核心归因 5/5、无批次丢失重复 5/5；R4–R7 执行时 Gate 直接 PASS，G2 已完成，待 G1/G3 | 是 | Pod annotation ↔ Node label；新增节点差集、唯一 Pod 与服务日志 Gate；与 K8s-only/时间窗口对照 |
